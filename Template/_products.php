        ...
        <div class="row">
                ...
                <div class="form-row pt-4 font-size-16 font-baloo">
                    ...
                    <div class="col">
                        ...
                        if (in_array($item['item_id'], $Cart->getCartId($product->getData('cart')) ?? [])){
                            ...
                            echo '<button type="submit" name="product_section_submit" class="btn btn-warning font-size-16 form-control">Add to Cart</button>';
                        }
                        ?>
                    </div>
                </div>
            ...
            <div class="col-sm-6 py-5">
                ...
                <div id="policy">
                    <div class="d-flex">
                        ...
                        <div class="return text-center mr-5">
                            ...
                            <a href="#" class="font-rale font-size-12">3 Day <br>Delivery</a>
                        </div>
                        <div class="return text-center mr-5">
                            <div class="font-size-20 my-2 color-second">
                ...
                <div id="order-details" class="font-rale d-flex flex-column text-dark">
                    ...
                    <small>Sold by <a href="#">PB Electronics </a>(4.5 out of 5 | 18,198 ratings)</small>
